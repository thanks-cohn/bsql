...
SRC=src/main.c src/where.c src/log.c src/location.c src/scan.c src/search.c src/meta.c src/explain.c src/tag.c src/note.c src/summary.c src/sidecar.c src/compile.c src/status.c src/clean.c src/logs.c src/missing.c src/rebuild.c src/doctor.c src/history.c src/id.c src/context.c
OUT=build/bsql
